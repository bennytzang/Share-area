...
public class MainActivity_clu extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_clu);
        Func();
    }
    private View.OnClickListener ClsBtn = new View.OnClickListener(){
        public void onClick(View v){
            AlertDialog.Builder bdr = new AlertDialog.Builder(MainActivity_clu.this);
            ...
            bdr.setPositiveButton("確定", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    MainActivity_clu.this.onDestory();
                }
            });
